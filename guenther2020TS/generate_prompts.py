...
for participant in participants:
    ...
    # instruction text
    prompt = 'In the following study, you will see complex words such as airport or warzone in the browser window. You will have to judge for each word whether it has a sensible interpretation or not.\n'\
