...
for participant in range(num_participants):
    ...
    for trial in range(num_trials):
        ...
        if (trial_temp - 1) % 20 == 0:
            ...
            prompt += 'Now you are in a ' + dif + ' and ' + str(rew) + ' cent block. ' + typ_str + col_str + pat_str + 'You press <<' + res.upper() + '>> to make a ' + acc + ' response.\n\n'
        else:
            prompt += 'You are still in a ' + dif + ' and ' + str(rew) + ' cent block. ' + typ_str + col_str + pat_str + 'You press <<' + res.upper() + '>> to make a ' + acc + ' response.\n\n'
        print(prompt)
